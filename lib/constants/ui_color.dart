...
class UiColor {
  ...
  static Map<int, Color> myBlueGrey() => {
    25: Color(0xFFFCFCFD),
    50: Color(0xFFF8F9FC),
  ...
  static Map<int, Color> myBlueLight() => {
    25: Color(0xFFF5FBFF),
    50: Color(0xFFF0F9FF),
